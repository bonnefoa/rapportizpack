...
L'analyseur permet de créer un arbre logique représentant le fichier XML qui lui a été passé.
...
En effet, les appels de l'analyseur sont transmis vers des classes internes et difficilement manipulables.
