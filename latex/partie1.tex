...
IzPack supporte la création d'installateurs multilangues.
...
A la fin de l'installation, il est possible de générer un script d'installation automatique.
...
Il prend la partie installation d'IzPack, la modifie pour correspondre à l'installation décrite dans le fichier xml, et la package avec l'application à installer.
...
Le processus d'installation est géré par la partie installateur de IzPack. Cette phase va permettre de déployer l'application sur toutes les machines nécessaires.
\begin{figure}[H]
	\centering
