...
Toutes les réalisations faites sont ouvertes et disponibles à tout le monde, c'est à dire que n'importe qui est libre de consulter, cloner ou de forker les projets présents sur GitHub cependant, 
le droit de commit est restraint aux utilisateurs choisies.
Il est également possible de créer des dépôts sous conditions de payer un abonnement

De nombreux projets utilisent GitHub comme plateforme, notamenent rails, Rspec, scriptaculous...
