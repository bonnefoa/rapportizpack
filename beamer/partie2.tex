...
% c'est bizarre de le mettre là...
\begin{frame}\frametitle{Parties touchées par le champignon NanoXMLus deprecatus}
\begin{beamerboxesrounded}[shadow=true]{Utilisation de NanoXML}
\begin{itemize}
	\item 3 Classes\\
	~\\
	\item 499 Utilisations
\end{itemize}
\end{beamerboxesrounded}
\end{frame}
%------------------------------------------------------------------------------
